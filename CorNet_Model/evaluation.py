...
from deepxml.evaluation import get_p_1, get_p_3, get_p_5, get_n_1, get_n_3, get_n_5, get_inv_propensity, get_n_12, get_p_12
from deepxml.evaluation import get_psp_1, get_psp_3, get_psp_5, get_psndcg_1, get_psndcg_3, get_psndcg_5, get_psp_12, get_psndcg_12
...
def main(results, targets, train_labels, a, b):
    ...
    if train_labels is not None:
        ...
        print('PSPrecision@12:', get_psp_12(res, targets, inv_w, mlb))
        print('PSnDCG@12:', get_psndcg_12(res, targets, inv_w, mlb))
